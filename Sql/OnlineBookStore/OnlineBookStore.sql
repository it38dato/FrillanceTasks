...
INSERT INTO `buy_book` VALUES (1,1,1,1),(2,1,7,2),(3,1,3,1),(4,2,8,2),(5,3,3,2),(6,3,2,1),(7,3,1,1),(8,4,5,1),(9,5,8,2),(10,5,2,1),(11,4,3,1),(12,4,4,1),(13,4,5,1);
...
CREATE TABLE `buy_pay` (
  ...
  `price` decimal(8,2) DEFAULT NULL,
  `amount` int DEFAULT NULL,
  `Стоимость` decimal(18,2) DEFAULT NULL
...
INSERT INTO `buy_pay` VALUES ('Белая гвардия ','Булгаков М.А.',540.50,1,540.50),('Лирика','Пастернак Б.Л.',518.99,2,1037.98);
/*!40000 ALTER TABLE `buy_pay` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `buy_pay1`
--

DROP TABLE IF EXISTS `buy_pay1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `buy_pay1`
--

LOCK TABLES `buy_pay1` WRITE;
/*!40000 ALTER TABLE `buy_pay1` DISABLE KEYS */;
INSERT INTO `buy_pay1` VALUES (5,3,1578.48);
/*!40000 ALTER TABLE `buy_pay1` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `stat` VALUES (0,600),(600,700),(700,10000);
...
INSERT INTO `supply` VALUES (2,'Черный человек','Есенин С.А.',570.20,6),(3,'Белая гвардия','Булгаков М.А.',540.50,7),(4,'Идиот','Достоевский Ф.М.',360.80,3);
...
-- Dump completed on 2022-06-04 12:22:15
